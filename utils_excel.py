...
def generate_bulkloader(price_data, savepath, template, yearnumber, versionnumber, config):
    excel_feed_path = os.path.join(savepath, 'templates', template)
    bulk_file_name = 'Rocky Bulk Loader.{}.{}.xlsx'.format(yearnumber, versionnumber)
